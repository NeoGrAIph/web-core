...
## Правила работы
- Текущий шаблон реализован на базе обработки шаблона `website` из upstream.
- Шаблоны Payload CMS 3 храним нетронутыми в `upstream/payload/templates/{website,ecommerce}`; оригиналы не правим.
...
- Для каждого файла фиксируем путь‑источник (из `upstream/payload/templates/website/**`) и, если структуру пришлось менять, причину.
