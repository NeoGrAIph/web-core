...
В нашей конфигурации это `https://kubernetes.services.synestra.tech:6443` (TLS завершается на Traefik, см. `synestra-platform/infra/ingress/traefik/resources/kubernetes-services-api-proxy.yaml`).
