...
- `docs/runbooks/runbook-media-refresh-dev-from-prod.md`
...
- В secret `web-<app>-<env>-s3-env` присутствуют `S3_ACCESS_KEY_ID`/`S3_SECRET_ACCESS_KEY` и они не “перезатираются” GitOps‑синком.
