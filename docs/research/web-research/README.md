...
| postgresql.org | Official PostgreSQL documentation site. | postgres, database, upgrade, migrations, sql, ddl | docs/research/web-research/postgresql.org/README.md |
...
| Upgrading a PostgreSQL Cluster | postgresql.org | Server Setup and Operation | Major vs minor upgrade overview with methods for upgrading a PostgreSQL cluster, including dump/restore, pg_upgrade, and replication approaches. | database, postgres, upgrade, migrations | docs/research/web-research/postgresql.org/pages/current-upgrading.html.md | https://www.postgresql.org/docs/current/upgrading.html |
| pg_upgrade | postgresql.org | PostgreSQL Server Applications | Reference for pg_upgrade, including requirements, usage, and options for in-place major upgrades. | database, postgres, upgrade, migrations | docs/research/web-research/postgresql.org/pages/current-pgupgrade.html.md | https://www.postgresql.org/docs/current/pgupgrade.html |
| ALTER TABLE | postgresql.org | SQL Commands | SQL reference for altering table definitions, covering common schema change operations and constraints. | database, postgres, sql, ddl, schema-changes, migrations | docs/research/web-research/postgresql.org/pages/current-sql-altertable.html.md | https://www.postgresql.org/docs/current/sql-altertable.html |
