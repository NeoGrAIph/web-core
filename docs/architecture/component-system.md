...
##### Проект обработки upstream‑шаблона

- Runbook проекта: `docs/runbooks/runbook-upstream-website-processing-project.md`
- Трекер: `docs/research/templates/payload-website/processing-project.md`
- Прогресс по файлам: `docs/research/templates/payload-website/processing-progress.md`
