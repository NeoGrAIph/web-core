...
export interface PluginConfig {
   ...
   * You can access default prompts by importing { defaultPrompts } from '@synestra/payload-plugin-ai'
   */
  prompts?: ActionPrompt[]
  /**
   * Custom seed prompt function for generating field-specific prompts
   * If not provided, uses default seed prompt function
   * You can access default seed prompts by importing { defaultSeedPrompts } from '@synestra/payload-plugin-ai'
  */
