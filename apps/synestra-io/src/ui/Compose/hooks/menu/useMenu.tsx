...
export const useMenu = (menuEvents: UseMenuEvents, options: UseMenuOptions) => {
  ...
  const MemoizedActiveComponent = useMemo(() => {
    const ActiveComponent = ({ isLoading, stop }: { isLoading: boolean; stop: () => void }) => {
    ...
    ActiveComponent.displayName = 'AiComposeActiveComponent'
  ...
  const MemoizedMenu = useMemo(() => {
    const MenuComponent = ({ isLoading, onClose }: { isLoading: boolean; onClose: () => void }) => (
    ...
    MenuComponent.displayName = 'AiComposeMenu'
