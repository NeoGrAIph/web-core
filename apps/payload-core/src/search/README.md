# apps/payload-core/src/search

## Назначение
Search UI и search plugin helpers.

## Границы модуля (не окончательные)
- Компонент поиска, beforeSync, fieldOverrides.
...
## Статус
Перенос планируется, пока не выполнен.
