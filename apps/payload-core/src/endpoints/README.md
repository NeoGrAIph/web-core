# apps/payload-core/src/endpoints

## Назначение
Seed endpoints и данные.

## Границы модуля (не окончательные)
- Только app‑локальные seed scripts и ассеты.
...
## Источники (for_cute)
- for_cute/src/endpoints/**

## Зависимости
- runbook-payload-seeding.md
...
## Статус
Перенос планируется; seed должен работать с локальными ассетами.
